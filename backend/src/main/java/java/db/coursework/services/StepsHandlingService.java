...
import db.coursework.services.AddMaterialToOvumContainerService;
import db.coursework.services.LabelService;
import db.coursework.services.MachineService;
import db.coursework.services.MaterialService;
import db.coursework.services.MoveOvumContainerToRoomService;
...
import db.coursework.services.RoomService;
...
public class StepsHandlingService {
    private final db.coursework.services.OvumContainerService ovumContainerService;
    private final db.coursework.services.OvumService ovumService;
    private final db.coursework.services.OrderService orderService;
    private final db.coursework.services.MachineService machineService;
    private final db.coursework.services.MaterialService materialService;
    private final db.coursework.services.RoomService roomService;
    private final db.coursework.services.LabelService labelService;
